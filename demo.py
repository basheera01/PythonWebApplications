...
with col1:
  ...
  st.image("everest.jpg",caption="Mount Everest",height=300,use_column_width=True)
...
with col2:
  st.subheader("K2")
  st.image("k2.jpg",caption="Mount K2",height=300,use_column_width=True)
...
col3=st.columns(1)
with col3:
  st.image("mount.gif",width=500,use_column_width=True)
